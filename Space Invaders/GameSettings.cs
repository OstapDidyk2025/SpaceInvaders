...
namespace Space_Invaders
{
    internal class GameSettings
    {
        ...
        public int AlienShipYCordinate { get; set; } = 4;
        public char AlienShipFigure { get; set; } = '\u028A';
        public int SwarmSpeed { get; set; } = 10;
        ...
        public int GroundObjectColumn { get; set; } = 78;
        ...
        public int GroundIsNotDestroyedCount { get; set; } = 78;


        //-------------------------------------------------

        public char AlienMissileFigure { get; set; } = '*';
        public int AlienMissileSpeed { get; set; } = 10;
    }
}
